<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Offer1.aspx.cs" Inherits="Offer1" %>
...
<body>
    ...
    <div style="padding-top:50px">
            ...
            <table>
                      <tr>
                        <td rowspan="11">
                            <img src="images/Offer1.jpg" hieght:90% align="left" style="height: 370px; width: 99%"/>
                        </td>
...
// FOr Capthca Start
  <tr>
      ...
      <td style="height:50px;width:100px;"><asp:Image ID="imgCaptcha" runat="server" /></td>
      <td><asp:Button ID="btnRefresh" runat="server" Text="Refresh" OnClick="btnRefresh_Click" /></td>
...
<tr>
   ...
   <td>
                    ...
                    <asp:TextBox ID="txtCaptcha" runat="server" Width="100px"></asp:TextBox>
